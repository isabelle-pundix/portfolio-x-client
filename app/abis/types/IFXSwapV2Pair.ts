...
export interface IFXSwapV2PairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface IFXSwapV2Pair extends BaseContract {
  connect(runner?: ContractRunner | null): IFXSwapV2Pair;
  waitForDeployment(): Promise<this>;

  interface: IFXSwapV2PairInterface;
