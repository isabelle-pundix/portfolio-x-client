...
export interface FXSwapV2FactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_HASH"
      | "allPairs"
...
export interface FXSwapV2Factory extends BaseContract {
  connect(runner?: ContractRunner | null): FXSwapV2Factory;
  waitForDeployment(): Promise<this>;

  interface: FXSwapV2FactoryInterface;
