...
export interface FXSwapV2PairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface FXSwapV2Pair extends BaseContract {
  connect(runner?: ContractRunner | null): FXSwapV2Pair;
  waitForDeployment(): Promise<this>;

  interface: FXSwapV2PairInterface;
