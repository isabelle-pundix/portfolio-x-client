...
export interface USDCLeverageVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASIS_POINTS"
      | "BORROWER"
  ...
  encodeFunctionData(
    functionFragment: "redeemExactTokens",
...
export interface USDCLeverageVault extends BaseContract {
  connect(runner?: ContractRunner | null): USDCLeverageVault;
  waitForDeployment(): Promise<this>;

  interface: USDCLeverageVaultInterface;
  ...
  redeemExactTokens: TypedContractMethod<
    [
  ...
  >;
  getFunction(
    nameOrSignature: "redeemExactTokens"
  ): TypedContractMethod<
    [
      _shares: BigNumberish,
      _assets: BigNumberish,
